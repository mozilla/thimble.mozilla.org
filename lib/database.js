module.exports = function() {
  ...
  // FOLLOW-UP: this should be turned into environment-variable-based
  //            connecting. Right now it uses sqlite, but we want MySQL
  //            or sqlite depending on env settings.

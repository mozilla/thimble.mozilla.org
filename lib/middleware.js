...
exports.finalizeProject = function(nunjucksEnv, env) {
  var generateOpenGraphData = function(metadata, url) {
    var metaTags = [{
          "name": "og:url",
          "content": url
        },{
  ...
  return function(req, res, next) {
    var sanitized = req.body.sanitizedHTML,
        ...
        metaTags = generateOpenGraphData(metadata, hostname + "/remix/" + req.publishId),
    ...
    finalized = finalized.replace("</head", metaTagsRender + "</head");

...
/** EXPERIMENTAL **/
              ...
              ["edit","remix"].forEach(function(suffix) {
                ...
                var ldata = "<html><head><<meta http-equiv='refresh' content='0; url="+thimbletarget+"'></head><body>"+suffix+" page soft-redirect</body></html>";
                headers = {
                  'x-amz-acl': 'public-read',
                  'Content-Length': Buffer.byteLength(ldata,'utf8'),
                  'Content-Type': 'text/html;charset=UTF-8'
                };
                ...
                s3.put(s3target, headers)
                  ...
                  .on("response", function(res) {
                    if (res.statusCode === 200) {
                      ...
                      console.log('redirect failed: '+res.statusCode);
                    }
                  })
                  .end(ldata);
              });

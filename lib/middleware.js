module.exports = function middlewareConstructor(env) {
  ...
  return {
    ...
    finalizeProject: function(nunjucksEnv, env) {
      ...
      var generateCustomUrl = function( req ) {
        var url = require( "url" ),
            subdomain = req.session.username + "/thimble/",
            domain = env.get( "USER_SUBDOMAIN" );

        req.publishLocation = "/" + subdomain + req.pageTitle;
        ...
        req.customUrl = domain.protocol + "//" + subdomain + "." + domain.host + req.pageTitle;
      ...
      return function(req, res, next) {
        var sanitized = req.body.sanitizedHTML,
            ...
            customUrl = generateCustomUrl( req ),

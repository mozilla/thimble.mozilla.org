module.exports = function middlewareCtor(env) {
  ...
  return {
    /**
     * Either generate the index.html data while setting the
     * session up for editing, or remixing. The first will
     * update the stored information on publish, the other
     * will create a new page on publish.
     */
    editOrRemixTemplate: function(appName, env, makeEnv, pageType) {
      return function(req, res) {
        req.session.pageEdit = (pageType === "edit");

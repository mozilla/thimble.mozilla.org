module.exports = function bleachConstructor(endpoint) {
   ...
   */
  function bleachData(data, callback) {
    sanitize({
      endpoint: endpoint,
      text: data,
      tags: ALLOWED_TAGS,
  ...
  return {
    bleachProjectPage: function(req, res, next) {
      bleachData(req.body.html, function(err, sanitizedData) {
        req.body.sanitizedHTML = sanitizedData;
        next(err);
      });
    },
    bleachMetaPage: function(req, res, next) {
      bleachData(req.body.detailsPage, function(err, sanitizedData) {
        req.body.sanitizedDetails = sanitizedData;
        next(err);
      });
    }
  };
